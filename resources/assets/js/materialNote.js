  ...
  */
  ...
  var EventHandler = function() {
    ...
    var hDimensionPickerMove = function(event, options) {
        ...
        var tableOptions = [];
            if ($hoverableOption.is(':checked')) tableOptions.push('highlight');
  ...
  var Renderer = function() {
    ...
    var tplShortcutTable = function(lang, options) {
      var template = [
          '<table class="bordered highlight">' + tplShortcutAction(lang, options) + '</table>',
          '<table class="bordered highlight">' + tplShortcutStyle(lang, options) + '</table>',
          '<table class="bordered highlight">' + tplShortcutText(lang, options) + '</table>',
          '<table class="bordered highlight">' + tplShortcutPara(lang, options) + '</table>'
      ].join('<br>');

      if (options.extraKeys) {
        //template.push('<table class="bordered highlight">' + tplExtraShortcuts(lang, options) + '</table>');
      }
      return template;
    };
    ...
    var tplDialogInfo = {
      image: function(lang, options) {
        ...
        var footer = '<button href="#" class="waves-effect waves-light btn-flat note-image-btn disabled" disabled>' + lang.image.insert + '</button>' +
                     '<button class="waves-effect waves-light btn-flat btnClose">' + lang.shortcut.close + '</button>';
      ...
      link: function(lang, options) {
        ...
        var footer = '<button href="#" class="waves-effect waves-light btn-flat note-link-btn disabled" disabled>' + lang.link.insert + '</button>' +
                     '<button class="waves-effect waves-light btn-flat btnClose">' + lang.shortcut.close + '</button>';
      ...
      help: function(lang, options) {
        ...
        var footer = '<button href="#" class="waves-effect waves-light btn-flat modal-close">' + lang.shortcut.close + '</button>';
