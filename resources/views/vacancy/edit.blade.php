...
@section('content')
    <main>
        ...
        @endif
            @if(count($types))
                    {{ Form::open(array('url' => '/vacancy/update/'.$post->post_id.'/'.$site->id, 'files' => true, 'class' => '')) }}
                        ...
                        <div class="col s12 card-panel white">
                            ...
                            <div class="row" id="tutorial-create-content">
                                <div class="input-field col s12" {{--id="wysiwyg-editor"--}}>
                                    ...
                                    <textarea id="material-editor" name="content" rows="4" class="material-editor materialize-textarea form-control" placeholder="Copy the Contents here">{!!$post->contents!!}</textarea>
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <div class="row" id="tutorial-create-type">
                                <div class="input-field col s12">
                                    <select name="type" id="type" required>
										<option value="" disabled>Edit a Job Role type (Required)</option>
                            ...
                            <div class="row">
                                <div class="input-field col s12">
                                    <select name="site" id="site" required>
										...
										@foreach($available_sites as $single_site)
											<option value="{{$single_site->id}}"
												@if($post->site_id == $single_site->id)
													selected
												@endif
                                    ...
                                    {{-- <select name="site" id="type" required>
        					...
        					@include('partials.resource-browser-vacancy')
                        </div>
                    </div>
